...
export default function Home() {
    return (
        <div className="bg-majorColor grid grid-cols-3 grid-rows-3 mx-auto h-screen py-4 px-5 md:px-16">
            <Head>
            ...
            <DisplayName layout="self-center col-start-1 col-end-2 row-start-2 row-end-3" />
            <BulletNav layout="self-center justify-self-end col-start-3 col-end-4 row-start-2 row-end-3" />
